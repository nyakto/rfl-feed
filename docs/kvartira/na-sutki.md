Раздел посуточной аренды квартир
--------------------------------
...
<rfl-feed xmlns="http://www.realtymag.ru/rfl">
	<offer internal-id="1085">
		<!--
			объект сделки
			строго ограниченные значения: квартира
		-->
		...
		<!--
			страховой депозит
			строго ограниченные значения: за 1 день, за 2 дня, по договоренности
		-->
		<safe-deposit>за 2 дня</safe-deposit>
		<building-info>
			<!--
				проект
		...
		<apartment-info>
			...
			<!--
				входная дверь
				строго ограниченные значения: деревянная, металлическая, бронированная, алюминиевая
			-->
			<entrance-door>металлическая</entrance-door>
			<!--
				напольное покрытие
				строго ограниченные значения: деревянная доска, паркет, линолеум, плитка, деревянное покрытие
			-->
