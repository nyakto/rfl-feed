...
<rfl-feed xmlns="http://www.realtymag.ru/rfl">
	<offer internal-id="1083">
		<!--
			объект сделки
			строго ограниченные значения: гараж, бокс капитальный, бокс некапитальный, металлический гараж, машиноместо, парковочное место
		-->
		...
		<remoteness>
			...
			<!--
				тип удаленности
				строго ограниченные значения: пешком до метро, общественным транспортом, электричкой, пешком до остановки
			-->
		...
		<parking-info>
			...
			<!--
				...
				строго ограниченные значения: многоуровневый паркинг, гаражный комплекс, подземный паркинг, ряды отдельных боксов, открытая стоянка
			-->
