...
<rfl-feed xmlns="http://www.realtymag.ru/rfl">
	<offer internal-id="1083">
		<!--
			объект сделки
			строго ограниченные значения: квартира в новостройке
		-->
		...
		<!--
			...
			строго ограниченные значения: по 214-ФЗ, купля-продажа
		-->
		<contract-conditions>купля-продажа</contract-conditions>
		<!--
			рассрочка платежа
			строго ограниченные значения: да, нет, true, false, 1, 0, +, -
		-->
		...
		<mortgage>
			...
			<allowed>да</allowed>
			<!--
				кем предоставляется ипотека
				текст
			-->
			<provider>Сбербанк</provider>
		</mortgage>
		<!--
			название жилого комплекса
			текст
		-->
		<district-name>ЖК Солнечный</district-name>
		<!--
			готовность объекта
			строго ограниченные значения: на стадии нулевого цикла, незавершенное строительство, готов к проживанию, готов под чистовую отделку, принято госкомиссией, оформлена в собственность
		-->
		...
		<!--
			...
			текст
		-->
		<release-date>3 2014</release-date>
		<!--
			дом принят комиссией
			строго ограниченные значения: да, нет, true, false, 1, 0, +, -
		-->
		<commettiee-checked>да</commettiee-checked>
		<building-info>
			<!--
			...
			<!--
				проект
				строго ограниченные значения: индивидуальный проект, П-44, П-44Т, П111-М, сталинский дом, ленинградский проект, И-155, П-44К, П-44ТМ, П-44/25, К-7
			-->
			...
			<!--
				материал строения
				строго ограниченные значения: панельный, кирпичный, монолит, хрущовка, деревянный, монолитно-кирпичный, сталинка, пеноблочный, блочный
			-->
			<material>кирпичный</material>
			<!--
				вид парковки
				строго ограниченные значения: охраняемая у дома, неохраняемая у дома, подземная, свободная
			-->
		...
		<apartment-info>
			...
			<rooms>
				...
				<!--
					расположение комнат
					строго ограниченные значения: изолированные, есть проходные
				-->
				<relation>изолированные</relation>
			</rooms>
			<!--
				вид планировки квартиры
				строго ограниченные значения: свободная, пентхаус, лофт, студия, стандартная, мансарда
			-->
			<plan-type>стандартная</plan-type>
			<!--
				отделка
				строго ограниченные значения: евроремонт, косметический ремонт, без отделки, нужен ремонт, дизайн проект, черновая отделка, финишная отделка
			-->
			<decoration>евроремонт</decoration>
			<!--
				окна
				строго ограниченные значения: деревянные, пластиковые, пластиковые стеклопакет, деревянные стеклопакет
			-->
			<windows>пластиковые стеклопакет</windows>
			<!--
				санузел
				строго ограниченные значения: раздельный, совмещенный
			-->
		...
		<infrastructure-info>
			<!--
				вид из окон
				строго ограниченные значения: во двор, на улицу, парк, пустырь, горы, водоем
			-->
