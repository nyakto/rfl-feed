Раздел продажи торговых площадей
--------------------------------
...
<rfl-feed xmlns="http://www.realtymag.ru/rfl">
	<offer internal-id="1083">
		<!--
			объект сделки
			строго ограниченные значения: торговое помещение, торговая площадь, помещение под магазин, помещение под супермаркет, павильон
		-->
