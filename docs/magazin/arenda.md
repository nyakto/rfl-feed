Раздел аренды торговых площадей
-------------------------------
...
<rfl-feed xmlns="http://www.realtymag.ru/rfl">
	<offer internal-id="1083">
		<!--
			объект сделки
			строго ограниченные значения: торговая площадь, помещение под торговлю, площадь под торговлю, street retail, павильон, прилавок, секция в тк
		-->
		<property-type>торговая площадь</property-type>
		<!--
			тип сделки
		...
		<!--
			...
			integer
		-->
		<stream-size>250</stream-size>
		<building-info>
			<!--
				место размещения торгового помещения
				строго ограниченные значения: отдельное капитальное здание, отдельное некапитальное здание, жилой дом, административное здание, торговый центр, торгово-развлекательный центр, офисный центр, рынок, многофункциональный комплекс, торгово-офисный центр, бинес-центр
			-->
		...
		<commercial-space-info>
			...
			<!--
				...
				набор строго ограниченных значений: продовольственный магазин, хозяйственный магазин, смешанный ассортимент, товары для авто, товары для дома, строительные материалы, одежда, обувь, галантерея, мебель, бытовая техника, компьютеры, аптека, медицинские товары, парфюмерия, косметика, непродовольственные товары
			-->
			<appropriation>
				<option>продовольственный магазин</option>
				<option>хозяйственный магазин</option>
				<option>смешанный ассортимент</option>
				<option>товары для авто</option>
				<option>товары для дома</option>
				<option>строительные материалы</option>
				<option>одежда</option>
				<option>обувь</option>
				<option>галантерея</option>
				<option>мебель</option>
				<option>бытовая техника</option>
				<option>компьютеры</option>
				<option>аптека</option>
				<option>медицинские товары</option>
				<option>парфюмерия</option>
				<option>косметика</option>
				<option>непродовольственные товары</option>
			</appropriation>
			<!--
				этаж
				integer
