...
<rfl-feed xmlns="http://www.realtymag.ru/rfl">
	<offer internal-id="1083">
		<!--
			объект сделки
			строго ограниченные значения: коттедж, загородный дом, домовладение, усадьба, вилла, особняк, имение, поместье
		-->
		...
		<!--
			класс недвижимости
			строго ограниченные значения: эконом-класс, бизнес-класс, премиум
		-->
		...
		<!--
			готовность объекта
			строго ограниченные значения: на стадии закладки, незавершенное строительство, готов к проживанию, готов под чистовую отделку, используется для проживания
		-->
		...
		<cottage-info>
			...
			<!--
				ограждение
				строго ограниченные значения: нет, металлический забор, кирпичный забор, деревянный забор, сетка
			-->
			...
			<!--
				отделка
				строго ограниченные значения: евроремонт, без отделки, готов под чистовую отделку
			-->
		...
		<lot-info>
			<area>
				...
				<!--
					единицы измерения
					строго ограниченные значения: сотка
				-->
				<unit>сотка</unit>
			</area>
			<!--
