Раздел посуточной аренды коттеджей
----------------------------------
...
<rfl-feed xmlns="http://www.realtymag.ru/rfl">
	<offer internal-id="1083">
		...
		<!--
			тип сделки
			строго ограниченные значения: посуточная аренда
		-->
		<offer-type>посуточная аренда</offer-type>
		<!--
		...
		<!--
			...
			integer
		-->
		<max-guests-count>20</max-guests-count>
		<cottage-info>
			<area>
				<!--
					площадь коттеджа
